...
- `GOTENBERG_URL` (default: `http://gotenberg:8080`)
...
- `gotenberg`: `gotenberg/gotenberg:8`, internal port `8080`
- `orchestrator`: this Go service, exposed on host `:8080`
...
```bash
curl -sS -X POST http://localhost:8080/v1/html \
